return {
    descriptions = {
        ...
        Other = {
            ...
            ch_m_force_stake_xp2 = {
                name = "",
                text = {
                    "{s:0.8,C:purple}#1#{s:0.8} XP per Ante"
                }
            },
            flint = {
                name = "Flint",
    ...
    misc = {
        dictionary = {
            k_area = "Area",
            b_area_cards = "Area Cards",
            k_lunar = "Lunar",
            b_lunar_cards = "Lunar Cards",
            k_stellar = "Stellar",
            b_stellar_cards = "Stellar Cards",
            k_elemental = "Elemental",
            b_elemental_cards = "Elemental Cards",
            k_attack = "Attack",
            b_attack_cards = "Attack Cards",
            k_loot = "Loot",
            b_loot_cards = "Loot Cards",
            b_learn = "LEARN",
            k_skill = "Skill",
            k_class = "Class",
            k_inactive = "inactive",
            nullified = "Nullified!",
            k_ex_expired = "Expired!",
            k_ex_decay = "Decayed!",
        ...
        v_text = {
            ...
            ch_c_blind_attack = {"Blinds may use {C:attention}Attack{} cards"},
            ch_c_astro_blinds = {"Only {C:attention}Astronaut{} blinds may show up."},
